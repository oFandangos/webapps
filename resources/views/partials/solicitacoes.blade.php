    ...
    @foreach ($webapps as $webapp)
        <div class="col-3">
            <div class="card">
                ...
                <div class="card-body">
                    <b>Domínio: </b>
                    <p class="card-text">{{ $webapp->dominio }}</p>
                    <b>Justificativa:</b>
                    ...
                    <div class="row">
                        ...
                        @if (in_array(auth()->user()->codpes ?? [], explode(',', config('webapps.admins'))))
                            <div class="col">
                                <a href="/aprovar/{{ $webapp->id }}" class="btn btn-primary"><i
                                        class="fas fa-thumbs-up"></i> Aprovar</a>
                            </div>
                            <div class="col">
                                <form method="post" action="/reprovar/{{ $webapp->id }}">
                                    ...
                                    <button type="submit" class="btn btn-danger"
                                        onClick="return confirm('Tem certeza?');"><i class="fas fa-thumbs-down"></i>
                                        Negar</button>
                                </form>
                            </div>
                        @endif
